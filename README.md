...
For this model, I used the closest strike relative to SPY's price as of 3/20/26. Going forward for future projects using Black-Scholes, I would use a delta 0.50 strike to find and use "true" ATM.
